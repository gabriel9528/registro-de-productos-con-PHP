                    ...
                    <table class="table align-middle">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Tipo de oferta en %</th>
                                <th scope="col">Ingresar el precio regular</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $dato->tipo_oferta; ?></td>
                                <td><?php echo $dato->precio_regular; ?></td>
                                <td><?php echo $dato->precio_descuento; ?></td>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <form class="p-4" method="POST" action="registrar.php">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Ingrese el tipo de oferta en %</label>
                        <input type="number"" class="form-control" name="txtOferta" autofocus required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Ingrese el precio regular: </label>
                        <input type="number" class="form-control" name="txtPrecioRegular" autofocus required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Ingrese el precio con descuento: </label>
